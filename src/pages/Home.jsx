          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-5">
              ...
              <p className="text-gray-600 leading-relaxed">
                The <strong>MCA/MBA program</strong> at Dr. Sudhakarrao Jadhavar Institute of
                Management and Technology is designed to develop skilled IT professionals
                with strong foundations in software development, data analytics, cloud
                computing, and emerging technologies.
              </p>

              <p className="text-gray-600 leading-relaxed">
                Our curriculum is aligned with industry requirements and focuses on
                hands-on learning, real-world projects, internships, and continuous
                skill enhancement to prepare students for successful careers in the IT
                sector.
              </p>
